...
const privateKey = "fccd3402ee7d38f748ec8989b90ceb28be78de174b40000025cda1ef1032e088";
const keyPair = ec.keyFromPrivate(privateKey, "hex");
const publicKey = keyPair.getPublic("hex");
// Public key: 04bf4187b0854e2317cbfd31b9a3c2503448284f154be98db61479c07af46e7a33be8504c0cc1b58b1ca2f2195a3a36e4184b93af00381dd74b7446fba85cea77e

const WS = require("ws");

const PORT = process.env.PORT || 3004;
const MY_ADDRESS = process.env.MY_ADDRESS || "ws://localhost:3004";
const PEERS = process.env.PEERS ? process.env.PEERS.split(","): ["ws://localhost:3003","ws://localhost:3005"];
...
//     // MineTransaction: Mine hết các giao dịch trong pool
